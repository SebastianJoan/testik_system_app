...
<div class="w-full h-auto px-9 py-9 gap-4 flex flex-col">
    <div class="w-full h-auto flex flex-col gap-2 md:flex-row md:gap-2 md:justify-between md:items-center md:justify-items-center ">
        <div class="w-auto h-auto flex flex-col gap-2 justify-center items-center justify-items-center">
            ...
            <a href="{{route('servicio.new')}}" class="px-2 py-2 w-full bg-white text-green-600 border-green-600 border hover:bg-green-800 hover:text-white rounded-sm shadow-sm  flex justify-center items-center justify-items-center">
            ...
            <a href="#" class="px-2 py-2 bg-white text-blue-600 border-blue-600 border hover:bg-blue-800 hover:text-white rounded-sm shadow-sm ">
                EXPORTAR LISTADO DE SERVICIOS: {{ $countServicios }}
            </a>
        </div>
        <form
            action="{{route('servicio.search')}}"
            method='GET'
            class="flex"
        >
            @csrf
    ...
    <div class="hidden md:flex md:flex-col md:w-full md:h-auto md:bg-gray-700 md:text-white">
        <div class="w-full h-auto py-2 px-2 flex flex-row justify-between items-center justify-items-center">
            <div class="w-1/5 flex justify-start items-center justify-items-center">
                <h3>
                    ID
                </h3>
            </div>
            ...
            <div class="w-1/5 flex justify-center items-center justify-items-center">
                <h3>
                    INFORMACION
                </h3>
            </div>
        ...
        <div class="flex flex-col bg-white text-black justify-center items-center justify-items-center">
            @foreach($servicio as $data)
                <div class="w-full h-auto py-2 px-2 flex flex-row justify-between items-center justify-items-center">
                    ...
                    <div class="w-1/4 flex justify-center items-center justify-items-center">
                        <a href="{{route('servicio.show',$data -> id_servicios)}}" class="w-full ">
                            <div class=" cursor-pointer px-2 py-2 flex justify-center items-center justify-items-center bg-white text-green-600 border-green-600 border hover:bg-green-800 hover:text-white rounded-sm shadow-sm ">
                                INFORMACION
                            </div>
                        </a>
                    </div>
    ...
    <div class="flex flex-col gap-4 md:hidden">
        @foreach($servicio as $data)
            <div class="w-full h-auto flex  bg-slate-800 text-white flex-col gap-3 rounded-sm px-2 py-2">
                ...
                <a href="{{route('servicio.show',$data -> id_servicios)}}" >
