...
<div class="w-full h-auto px-9 py-9 gap-4 flex flex-col">
    <div class="w-full h-auto flex flex-col gap-2 md:flex-row md:gap-2 md:justify-between md:items-center md:justify-items-center ">
        <div class="w-auto h-auto flex flex-col gap-2 justify-center items-center justify-items-center">
            ...
            <a href="{{route('cliente.new')}}" class="px-2 py-2 w-full bg-white text-green-600 border-green-600 border hover:bg-green-800 hover:text-white rounded-sm shadow-sm  flex justify-center items-center justify-items-center">
                AGREGAR NUEVO CLIENTE
            </a>
            <a href="#" class="px-2 py-2 w-full bg-white text-blue-600 border-blue-600 border hover:bg-blue-800 hover:text-white rounded-sm shadow-sm flex justify-center items-center justify-items-center">
                EXPORTAR LISTADO DE CLIENTES: {{ $countClientes }}
            </a>
        </div>
        <form
            action="{{route('cliente.search')}}"
            method='GET'
            class="flex"
        >
            @csrf
        ...
        <div class="flex flex-col bg-white text-black justify-center items-center justify-items-center">
            @foreach($Clientes as $data)
                <div class="w-full h-auto py-2 px-2 flex flex-row justify-between items-center justify-items-center">
                    ...
                    <a href="{{route('cliente.show',$data -> id_clientes)}}" class="w-1/4">
